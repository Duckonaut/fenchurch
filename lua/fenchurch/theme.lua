...
local c = require('fenchurch.palette')
...
theme.set_highlights = function()
  ...
  hl(0, "MsgSeparator", { fg = c.bg, bg = c.bg })
  ...
  hl(0, "Character", { fg = c.light_green, bg = 'NONE', bold=true, })
  hl(0, "Constant", { fg = c.orange, bg = 'NONE', bold=true, })
  ...
  hl(0, "Function", { fg = c.vivid_blue, bg = 'NONE', bold=true, })
  hl(0, "Operator", { fg = c.cyan, bg = 'NONE' })
  hl(0, "Type", { fg = c.yellow, bg = 'NONE', bold=true, })
  ...
  hl(0, "Label", { fg = c.light_green, bg = 'NONE' })
  hl(0, "Exception", { fg = c.magenta, bg = 'NONE' })
  hl(0, "Include", { fg = c.magenta, bg = 'NONE', bold=true, })
  hl(0, "PreProc", { fg = c.magenta, bg = 'NONE', bold=true, })
  hl(0, "Define", { fg = c.orange, bg = 'NONE', bold=true, })
  hl(0, "Macro", { fg = c.orange, bg = 'NONE', bold=true, })
  ...
  hl(0, "TSType", { fg = c.yellow, bg = 'NONE', bold=true, })
  hl(0, "TSTypeBuiltin", { fg = c.orange, bg = 'NONE', bold=true, })
  hl(0, "TSConditional", { fg = c.yellow, bg = 'NONE' })
  hl(0, "TSException", { fg = c.purple, bg = 'NONE' })
  hl(0, "TSInclude", { fg = c.light_green, bg = 'NONE', bold=true, })
  hl(0, "TSKeywordReturn", { fg = c.magenta, bg = 'NONE', bold=true, })
  hl(0, "TSKeyword", { fg = c.magenta, bg = 'NONE' })
  hl(0, "TSKeywordFunction", { fg = c.magenta, bg = 'NONE', bold=true, })
  hl(0, "TSLabel", { fg = c.light_blue, bg = 'NONE' })
  hl(0, "TSNamespace", { fg = c.light_blue, bg = 'NONE' })
  ...
  hl(0, "TSCharacter", { fg = c.light_green, bg = 'NONE', bold=true, })
  hl(0, "TSError", { fg = c.error_red, bg = 'NONE' })
  hl(0, "TSFunction", { fg = c.vivid_blue, bg = 'NONE', bold=true, })
  hl(0, "TSFuncBuiltin", { fg = c.blue, bg = 'NONE', bold=true, })
  hl(0, "TSMethod", { fg = c.vivid_blue, bg = 'NONE' })
  hl(0, "TSConstMacro", { fg = c.orange, bg = 'NONE', bold=true, })
  hl(0, "TSFuncMacro", { fg = c.vivid_blue, bg = 'NONE', bold=true, })
  hl(0, "TSVariable", { fg = c.light_blue, bg = 'NONE' })
  hl(0, "TSVariableBuiltin", { fg = c.cyan, bg = 'NONE', bold=true, })
  hl(0, "TSProperty", { fg = c.light_blue, bg = 'NONE' })
  hl(0, "TSField", { fg = c.fg, bg = 'NONE' })
  hl(0, "TSParameter", { fg = c.light_red, bg = 'NONE' })
  hl(0, "TSParameterReference", { fg = c.light_red, bg = 'NONE' })
  ...
  hl(0, "TSPunctSpecial", { fg = c.alt_fg, bg = 'NONE' })
  hl(0, "TSString", { fg = c.light_green, bg = 'NONE' })
  hl(0, "TSStringRegex", { fg = c.green, bg = 'NONE' })
  hl(0, "TSStringEscape", { fg = c.orange, bg = 'NONE', bold=true, })
  ...
  hl(0, "TSKeywordOperator", { fg = c.magenta, bg = 'NONE' })
  ...
  hl(0, "markdownId", { fg = c.magenta, bg = 'NONE' })
  ...
  hl(0, "NvimTreeGitNewIcon", { fg = c.tree_sign_add, bg = 'NONE' })
  hl(0, "NvimTreeGitRenamedIcon", { fg = c.tree_sign_add, bg = 'NONE' })
  hl(0, "NvimTreeGitDeletedIcon", { fg = c.sign_delete, bg = 'NONE' })
  hl(0, "NvimTreeGitMergeIcon", { fg = c.tree_sign_change, bg = 'NONE' })
  hl(0, "NvimTreeGitDirtyIcon", { fg = c.tree_sign_change, bg = 'NONE' })
  ...
  hl(0, "StatusLineSeparator", { fg = c.bg, bg = c.bg })
  hl(0, "StatusLineTerm", { fg = c.bg, bg = c.bg })
  hl(0, "StatusLineTermNC", { fg = c.bg, bg = c.bg })
